...
router.get('/responsibilities', authorizeRole('University Admin'), roleController.listRoleResponsibilities);
router.get('/:id', authorizeRole('University Admin'), roleController.getRole);
router.get('/:id/responsibilities', authorizeRole('University Admin'), roleController.getRoleResponsibilities);
